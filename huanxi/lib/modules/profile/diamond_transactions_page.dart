...
class DiamondTransactionsPage extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<DiamondTransactionsPage> createState() =>
      _DiamondTransactionsPageState();
}

class _DiamondTransactionsPageState
    extends ConsumerState<DiamondTransactionsPage> {
  final List<_DiamondRecord> _records = <_DiamondRecord>[];
  ...
  List<_DiamondRecord> _filteredRecords() {
    if (_filter == 1) {

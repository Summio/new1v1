...
const configDefs = [
  ...
  },
  {
    group: '计费配置',
    name: '通话手续费开关',
    key: 'call_service_fee_enabled',
    type: 'bool',
    defaultValue: '0',
    description: '开启后，通话超过阈值后的已计费分钟会按比例收取手续费',
  },
  {
    group: '计费配置',
    name: '通话手续费阈值',
    key: 'call_service_fee_threshold_minutes',
    type: 'number',
    unit: '分钟',
    min: 0,
    max: 1000000,
    defaultValue: '0',
    description: '单次通话已计费分钟数超过该值后，后续分钟进入手续费规则',
  },
  {
    group: '计费配置',
    name: '通话付费方手续费比例',
    key: 'call_service_fee_payer_rate_bps',
    type: 'percent',
    unit: '%',
    min: 0,
    max: 100,
    defaultValue: '0',
    description: '通话超过阈值后，向付费方额外收取的每分钟手续费比例',
  },
  {
    group: '计费配置',
    name: '通话收益方手续费比例',
    key: 'call_service_fee_income_rate_bps',
    type: 'percent',
    unit: '%',
    min: 0,
    max: 100,
    defaultValue: '0',
    description: '通话超过阈值后，从收益方每分钟收益中扣除的手续费比例',
  },
  {
    group: '计费配置',
    name: '礼物手续费开关',
    key: 'gift_service_fee_enabled',
    type: 'bool',
    defaultValue: '0',
    description: '开启后，单个礼物单价超过阈值时向送礼方收取手续费',
  },
  {
    group: '计费配置',
    name: '礼物手续费阈值',
    key: 'gift_service_fee_threshold_coins',
    type: 'number',
    unit: '金币',
    min: 0,
    max: 100000000,
    defaultValue: '0',
    description: '单个礼物单价超过该金币数后进入手续费规则',
  },
  {
    group: '计费配置',
    name: '礼物手续费比例',
    key: 'gift_service_fee_rate_bps',
    type: 'percent',
    unit: '%',
    min: 0,
    max: 100,
    defaultValue: '0',
    description: '礼物手续费比例，保存为万分比',
  },
  {
    group: '互动限制',
    name: '关注仅允许异性之间',
  ...
  },
  {
    group: '安全配置',
    name: '全局防截图(安卓)',
    key: 'security_android_prevent_screenshot_enabled',
    type: 'bool',
    defaultValue: '1',
    description: '开启后安卓端禁止截图和录屏预览',
  },
  {
    group: '安全配置',
    name: '全局防截图(iOS)',
    key: 'security_ios_prevent_screenshot_enabled',
    type: 'bool',
    defaultValue: '0',
    description: 'iOS 当前为占位配置，客户端仅接收配置，不执行真实防截图',
  },
  {
    group: '曝光配置',
    name: '活跃页置顶冷却时间',

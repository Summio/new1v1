...
class AppUserProfileUpdateIn(BaseModel):
    ...
    birth_date: Optional[date] = Field(default=None, description="出生日期，范围1960-01-01至当天")
    height_cm: Optional[int] = Field(default=None, description="身高(cm)，范围130-200")
    weight_kg: Optional[int] = Field(default=None, description="体重(kg)，范围30-100")

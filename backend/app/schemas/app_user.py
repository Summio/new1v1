...
class AppUserProfileUpdateIn(BaseModel):
    ...
    birth_date: Optional[date] = Field(default=None, description="出生日期，范围1975-01-01至当天")
    height_cm: Optional[int] = Field(default=None, description="身高(cm)，范围130-230")
    weight_kg: Optional[int] = Field(default=None, description="体重(kg)，范围30-130")
